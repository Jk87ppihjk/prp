// ! Arquivo: productRoutes.js (Completo e Finalizado)
...
router.get('/products', async (req, res) => {
    try {
        ...
        // ! LOG CRÍTICO PARA DEBUG DO FRONTEND (TYPEERROR)
        if (products.length > 0) {
            console.log(`[PRODUCTS] Sucesso: Retornando ${products.length} produtos. Primeiro preço (tipo original):`, products[0].price);
        } else {
...
// 3. Rota para ATUALIZAR um produto (PROTEGIDA)
...
// 4. Rota para DELETAR um produto (PROTEGIDA)
